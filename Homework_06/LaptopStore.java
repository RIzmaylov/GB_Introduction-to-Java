...
public class LaptopStore {
    ...
    public static void main(String[] args) {
        ...
        printList(list);    // вывожу полный список для удобства проверки выборки
        ...
        while (nextRequest != 5) {
            ...
            switch (nextRequest) {
                case 1:
                    ...
                    break;
                case 2:
                    System.out.println("Напишите минимальное значение желаемого объема ЖД: \n");
                    int rom = iScanner.nextInt();
                    System.out.println();
                    requests.put(nextRequest, rom);
                    break;
                case 3:
                    System.out.println("Выберите желаемую ОС: \n");
                    printItems(os);
